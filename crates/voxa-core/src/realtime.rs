...
impl RealtimeProfileError {
    pub const fn code(self) -> &'static str {
        match self {
            Self::ZeroLatencyBudget => "VOXA-RT-LATENCY-ZERO",
            Self::LatencyBudgetUnbounded => "VOXA-RT-LATENCY-UNBOUNDED",
            Self::AudioRangeRequired => "VOXA-RT-AUDIO-RANGE-REQUIRED",
            Self::AudioRangeForbidden => "VOXA-RT-AUDIO-RANGE-FORBIDDEN",
            Self::InvalidAudioRange => "VOXA-RT-AUDIO-RANGE",
            Self::ZeroCapacity => "VOXA-RT-CAPACITY-ZERO",
            Self::CapacityUnbounded => "VOXA-RT-CAPACITY-UNBOUNDED",
            Self::ZeroMediaDurationLimit => "VOXA-RT-MEDIA-LIMIT-ZERO",
            Self::MediaDurationLimitUnbounded => "VOXA-RT-MEDIA-LIMIT-UNBOUNDED",
            Self::MergeDurationRequired => "VOXA-RT-MERGE-REQUIRED",
            Self::MergeDurationForbidden => "VOXA-RT-MERGE-FORBIDDEN",
            Self::InvalidMergeDuration => "VOXA-RT-MERGE-RANGE",
            Self::ZeroDeadline => "VOXA-RT-DEADLINE-ZERO",
            Self::DeadlineUnbounded => "VOXA-RT-DEADLINE-UNBOUNDED",
            Self::DeadlineExceedsLatencyBudget => "VOXA-RT-DEADLINE-BUDGET",
            Self::LosslessDrop => "VOXA-RT-LOSSLESS-DROP",
            Self::StrictOrderingDrop => "VOXA-RT-STRICT-DROP",
            Self::SilenceDropNotPermitted => "VOXA-RT-SILENCE-DROP",
            Self::UnpausableBackpressureOnly => "VOXA-RT-UNPAUSABLE-BACKPRESSURE",
        }
    }
}
