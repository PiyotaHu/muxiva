...
use crate::{
    ErrorCategory, NamespacedName, NodeId, ProducerId, Result, SchemaVersion, Value, VoxaError,
};
...
pub enum ExtensionProducer {
    /// An extension produced by Voxa core.
    Core,
...
mod tests {
    ...
    fn extensions_reject_duplicate_key_and_version_but_allow_migration_versions() {
        ...
        .unwrap_err();
        assert_eq!(error.code(), "VOXA-FRM-EXTENSION-DUPLICATE");
