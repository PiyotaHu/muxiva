...
Security vulnerabilities must follow [SECURITY.md](SECURITY.md). The project
does not currently offer commercial support or guaranteed response times.

## 中文说明

使用问题和架构讨论请发到 Discussions；可复现 Bug 请发到 Issues，并提供版本、
系统、语言环境、期望结果、实际结果和最小复现。安全漏洞必须私密报告。
