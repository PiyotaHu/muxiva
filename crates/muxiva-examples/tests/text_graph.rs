...
#[test]
fn text_graph_explains_its_dsl_lifecycle_and_result_with_muxiva_branding() {
    ...
    assert_eq!(
        ...
        concat!(
            "[MUXIVA][INFO][graph.loaded] id=example.text-uppercase nodes=3 edges=2\n",
            ...
            "[MUXIVA][INFO][runtime.started] mode=sync source_frames=2\n",
            "[MUXIVA][INFO][runtime.completed] status=success outputs=2\n",
            "[MUXIVA][RESULT] HELLO, MUXIVA\n",
        )
    );
}
