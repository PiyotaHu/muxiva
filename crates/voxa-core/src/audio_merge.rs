...
use voxa_types::{ErrorCategory, Frame, FrameId, Timestamp, TransformOrigin, VoxaError};
...
fn duration_ns_for_samples(samples: u64, sample_rate_hz: u32) -> voxa_types::Result<u64> {
