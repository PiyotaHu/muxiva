...
fn panic_abort(
    ...
    AbortReason::new(
        ...
        node_id.cloned(),
        stage,
        AbortRootContext::new("VOXA-RUN-PANIC", panic_message(payload.as_ref()), details),
    )
}
...
const fn frame_type_name(frame_type: voxa_types::FrameType) -> &'static str {
    match frame_type {
        voxa_types::FrameType::Audio => "Audio",
        voxa_types::FrameType::Video => "Video",
        voxa_types::FrameType::Text => "Text",
        voxa_types::FrameType::Byte => "Byte",
        voxa_types::FrameType::Signal => "Signal",
        voxa_types::FrameType::Event => "Event",
    }
}
