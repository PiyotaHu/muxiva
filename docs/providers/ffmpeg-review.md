...
| Default dependency | Disabled; FFmpeg is never fetched or linked by Voxa Core |
| License/distribution | Voxa does not redistribute FFmpeg; distributors must audit the license and configuration of their chosen FFmpeg build |
