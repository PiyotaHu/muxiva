...
use voxa_core::{ForeignCommand, ForeignNodeDriver, ForeignSubmitOutcome};
use voxa_types::EventFrame;
...
pub(crate) fn try_enqueue_event(
    ...
    let accepted = matches!(
        driver.try_submit(
            ForeignCommand::new(current, voxa_core::ForeignCommandKind::Event(event)),
