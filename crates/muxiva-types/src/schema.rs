...
use crate::{ErrorCategory, MuxivaError, Result};
...
mod tests {
    ...
    fn schema_version_rejects_zero() {
        ...
        assert_eq!(error.code(), "MUXIVA-FRM-SCHEMA-VERSION");
    }
    ...
    fn namespace_rejects_every_grammar_failure_with_one_stable_code() {
        for value in [
            ...
            assert_eq!(error.category(), ErrorCategory::Validation);
            assert_eq!(error.code(), "MUXIVA-FRM-NAMESPACE");
